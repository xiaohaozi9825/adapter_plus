...
import pw.xiaohaozi.adapter_plus.adapter.SelectSimpleAdapter;
import pw.xiaohaozi.adapter_plus.holder.SelectHolder;


public class ImageSelectSimpleAdapter extends SelectSimpleAdapter<ItemSelectImageBinding, String, SelectHolder<ItemSelectImageBinding>> {
    private int mSpanCount;

    public ImageSelectSimpleAdapter(int spanCount) {
